...
const JavaScriptRoundedIcon = () => <BaseRoundedIcon Icon={JavaScriptIcon} />;

const ShieldEchoesRoundedIcon = () => (
	<BaseRoundedIcon Icon={ShieldEchoesIcon} offsetX="2%" offsetY="5%" />
);

const ReactRoundedIcon = () => <BaseRoundedIcon Icon={ReactIcon} />;

const BackendRoundedIcon = () => <BaseRoundedIcon Icon={BackendIcon} />;

const MobileRoundedIcon = () => <BaseRoundedIcon Icon={MobileIcon} />;

const AiRoundedIcon = () => <BaseRoundedIcon Icon={AiIcon} offsetY="-1%" />;
