...
const App = () => {
  ...
  const handleChange = throttle((event) => {
    ...
    else if (value === 'second-input') handleSecondItem();
    else if (value === 'third-input') handleThirdItem();
    else if (value === 'forth-input') handleForthItem();
    else if (value === 'fifth-input') handleFifthItem();
  }, 5000);
